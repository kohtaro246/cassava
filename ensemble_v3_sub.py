...
model_path = '../input/parametersv3/cnn_2_v3_1.pth'
cnn_2_1.load_state_dict(torch.load(model_path))
model_path = '../input/parametersv3/cnn_2_v3_2.pth'
cnn_2_2.load_state_dict(torch.load(model_path))

model_path = '../input/parametersv3/resnext_v3_1.pth'
resnext_1.load_state_dict(torch.load(model_path))
model_path = '../input/parametersv3/resnext_v3_2.pth'
resnext_2.load_state_dict(torch.load(model_path))

model_path = '../input/parametersv3/efficient_net_v3_1.pth'
efficient_net_1.load_state_dict(torch.load(model_path))
model_path = '../input/parametersv3/efficient_net_v3_2.pth'
...
with torch.no_grad():
    ...
    for image, ans in tqdm(testloader): 
